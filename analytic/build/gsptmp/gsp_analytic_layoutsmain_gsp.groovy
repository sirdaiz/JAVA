...
class gsp_analytic_layoutsmain_gsp extends GroovyPage {
...
printHtmlPart(6)
invokeTag('message','g',22,['code':("spinner.alt"),'default':("Loading&hellip;")],-1)
printHtmlPart(7)
})
...
public static final long LAST_MODIFIED = 1464189825000L
